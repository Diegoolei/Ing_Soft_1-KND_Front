...
export const setPlayerPortraits = (player_array, cur_pl_nick) => {
  ...
  const pos_constructor = (nick, top, left) => {
    return {
      nick: nick,
      top: top,
      left: left
